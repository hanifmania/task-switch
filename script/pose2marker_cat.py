...
class ObsMarker:
    def __init__(self):
        ...
        self.pubtopic = "/visualization/cat"
    ...
    def main(self):
        while not rospy.is_shutdown():
            ...
            self.marker.pose.orientation.x = 0.53
            self.marker.pose.orientation.y = 0.0
            self.marker.pose.orientation.z = 0.0
            self.marker.pose.orientation.w = 0.53
            ...
            self.marker.mesh_resource = "package://task_switch/meshes/lowpolycat/cat.dae"
